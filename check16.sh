...
#
# CHANGE LOG:   - Fixed randomizer use $RANDOM, remove /dev/urandom + od
...
# $ cp iplookup.py ~/bin/iplookup  # this is currently broken
# $ cp GeoIP*.dat ~/bin
...
# $ check16 -e 156.14.58.198    # this is currently broken 
#####################################################################
#############################################################################################################################################################################
#                                         ACKNOWLEDGEMENTS
#############################################################################################################################################################################
...
end=$( expr $RANDOM % 255 | awk '{print $1}')
